          ...
          <div className="mtrans-cards-grid">
            <div className="mtrans-contact-card">
              ...
              <ul className="mtrans-contact-list">
                ...
                <li><div className="mtrans-icon-box"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg></div><span className="mtrans-info-text">birlik1020@gmail.com</span></li>
        ...
        <div className="wrap">
          <div className="contact-card">
            <div className="c-left">
              ...
              <div className="c-line"><div className="ci"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="5" width="18" height="14" rx="2"/><path d="M3 7l9 6 9-6"/></svg></div><div><div className="k">{t('label_email')}</div><div className="v">birlik1020@gmail.com</div></div></div>
